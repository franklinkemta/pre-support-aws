  ...
  return (
    <div className="flex flex-col justify-center align-middle items-center place-items-center h-full mt-7 text-white">
      ...
      <div className="inline-flex ">
        <audio className="invisible" ref={audioPlayerRef} controls />
      ...
      <div className="inline-flex fixed bottom-0 p-2 text-white" >
        {statusMessage && <div className="animate-pulse">{statusMessage}</div>}
      </div>
    </div>
  )
}
